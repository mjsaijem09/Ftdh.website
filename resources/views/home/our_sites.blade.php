...
<div class="our_sites" id="our_sites">
<center>
<body>
    <section class="deca">
<div class="container" width="100%">
     ...
     <center>
@foreach($our_sites as $sites)


<div class="promoBox danger-ribbon">
    <center>
    <aside><p>Visit Now!</p></aside>
    <h4>Site: <br><strong>{{$sites->name_of_site}}</strong></h4>
    <br><h5>Address: <br><strong>{{$sites->address}}</strong></h5>
    <h5>Contact: <br><strong>{{$sites->number}}</strong></h5>
</center>
</div>
