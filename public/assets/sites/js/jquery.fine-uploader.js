...
(function(global) {
        ...
        qq.basePrivateApi = {
            ...
            _createUploadButton: function(spec) {
                ...
                button = new qq.UploadButton({
                    ...
                    token: this._options.request.getToken,
                    onChange: function(input) {
    ...
    qq.FormUploadHandler = function(spec) {
        "use strict";
        var options = spec.options, handler = this, proxy = spec.proxy, formHandlerInstanceId = qq.getUniqueId(), onloadCallbacks = {}, detachLoadEvents = {}, postMessageCallbackTimers = {}, isCors = options.isCors, inputName = options.inputName, getToken = options.getToken, albumName = options.albumName, getUuid = proxy.getUuid, log = proxy.log, corsMessageReceiver = new qq.WindowReceiveMessage({
            log: log
        });
        ...
        qq.override(this, function(super_) {
            return {
                add: function(id, fileInput) {
                    ...
                    fileInput.setAttribute("name", getToken);
                    fileInput.setAttribute("name", albumName);
    ...
    qq.traditional.FormUploadHandler = function(options, proxy) {
        ...
        function createForm(id, iframe) {
            ...
            params[options.albumName] = $('#album_name').val();
    ...
    qq.traditional.XhrUploadHandler = function(spec, proxy) {
        ...
        var handler = this, getName = proxy.getName, getSize = proxy.getSize, getUuid = proxy.getUuid, log = proxy.log, multipart = spec.forceMultipart || spec.paramsInBody, addChunkingSpecificParams = function(id, params, chunkData) {
            ...
            params[spec.albumName] = $('#album_name').val();
            params[spec.filenameParam] = name;
            params[spec.totalFileSizeName] = size;
            ...
            if (!spec.paramsInBody) {
                if (!multipart) {
                    ...
                    params[spec.getToken] = name;
                    params[spec.albumName] = name;
                }
                endpoint = qq.obj2url(params, endpoint);
            }
            ...
            if (multipart) {
                ...
                formData.append(spec.getToken, $('meta[name="_token"]').attr('content'));
                formData.append(spec.albumName, $('#album_name').val());
                return formData;
            }
            return fileOrBlob;
